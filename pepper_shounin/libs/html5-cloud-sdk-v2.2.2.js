...
root.KiiACL = (function() {
  ...
  KiiACL.prototype._thingWithID = function(id) {
    return root.KiiThing._thingWithID(id);
  };
  ...
  KiiObject.objectWithURI = function(uri) {
    ...
    if (compLength >= 4) {
      ...
      if (components[0] === "groups") {
        ...
        subject = root.KiiThing._thingWithID(components[1]);
      }
      bucket = null;
      if (root.KiiEncryptedBucket._isEncrypted(bucketName)) {
    ...
    requestCallbacks = {
      success: function() {
        ...
        try {
          ...
          return callbacks.failure(null, "failed to parse response: "+error1.message);
        }
      },
      failure: function() {
        var errString, error1, json;
  ...
  KiiAppAdminContext.prototype._objectWithURI = function(objectUri) {
    ...
    if (compLength >= 4 && valid) {
      ...
      if (components[0] === "groups" && compLength === 6) {
        ...
        subject = root.KiiThingAdmin._thingWithID(components[1], this._token);
...
root.KiiThing = (function() {
  ...
  KiiThing.prototype.isOwner = function(owner, callbacks) {
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        try {
          ownerUrl = _this._getOwnerURL(owner);
        } catch (error1) {
          message = error1;
  ...
  KiiThing.prototype._getOwnerURL = function(owner) {
    var oid, type;
    ...
    return (root.Kii.getBaseURL()) + "/apps/" + (root.Kii.getAppID()) + "/things/" + this._thingID + "/ownership/" + type + ":" + oid;
  };
  ...
  KiiThing._thingWithID = function(thingID) {
    var thing;
...
root.KiiThingAdmin = (function(superClass) {
  ...
  KiiThingAdmin._thingWithID = function(thingID, adminToken) {
    var thingAdmin;
    thingAdmin = new root.KiiThingAdmin(null, thingID, null, adminToken);
    return thingAdmin;
  };
